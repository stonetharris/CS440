...
public class SimulatedAnnealingAgent
	extends Agent
{

    public static double EPSILON = 1e-6;    // how close to zero should the temp be before we give up?
    ...
    private int time;                       // number of times simulated annealing has suggested a move
                                            // this is DIFFERENT from the # of turns in the game
